...
<div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        <h1 class="text-white mb-3">Berdonasilah untuk meringankan beban mereka</h1>
        <p><a href="#" class="btn btn-primary py-3 px-4 rounded-0">Donate Now</a></p>
      </div>

      <div class="owl-carousel owl-1 ">
        <div class="ftco-cover-1 overlay" style="background-image: url('assets/images/hero_1.jpg');"></div>
    ...
    <div class="container">
      <div class="feature-29192-wrap d-md-flex" style="margin-top: -20px; position: relative; z-index: 2;">
        ...
        <a href="#" class="feature-29192 overlay-danger" style="background-image: url('assets/images/img_3_gray.jpg');">
          <div class="text">
        ...
        <a class="feature-29192 overlay-success" style="background-image: url('assets/images/img_2_gray.jpg');">
          <div class="text">
        ...
        <div class="feature-29192 overlay-warning" style="background-image: url('assets/images/img_1_gray.jpg');">
          <div class="text">
              ...
              <div class="cause shadow-sm">
                ...
                <a href="#" class="cause-link d-block">
                  ...
                  <div class="custom-progress-wrap">
                    <span class="caption">89% complete</span>
                    <div class="custom-progress-inner">
                      <div class="custom-progress bg-danger" style="width: 89%;"></div>
                    </div>
                  </div>
                </a>
                ...
                <div class="px-3 pt-3 border-top-0 border border shadow-sm">
                  ...
                  <h3 class="mb-4"><a href="#">Pendidikan untuk Rohingya</a></h3>
                  <div class="border-top border-light border-bottom py-2 d-flex">
                    <div>Donated</div>
                    <div class="ml-auto"><strong class="text-primary">$89,125</strong></div>
                  </div>

                  <div class="py-4">
                    <div class="d-flex align-items-center">
                      <img src="{!! asset('assets/images/person_1.jpg') !!}" alt="Image" class="rounded-circle mr-3" width="50">
                      <div class="">Mark Zuckerberg</div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-md-4">
            ...
            <div class="cause shadow-sm">
                ...
                <a href="#" class="cause-link d-block">
                  ...
                  <div class="custom-progress-wrap">
                    <span class="caption">57% complete</span>
                    <div class="custom-progress-inner">
                      <div class="custom-progress bg-primary" style="width: 57%;"></div>
                    </div>
                  </div>
                </a>
                ...
                <div class="px-3 pt-3 border-top-0 border border shadow-sm">
                  ...
                  <h3 class="mb-4"><a href="#">Kesehatan Gaza</a></h3>
                  <div class="border-top border-light border-bottom py-2 d-flex">
                    <div>Donated</div>
                    <div class="ml-auto"><strong class="text-primary">$11,919</strong></div>
                  </div>
          ...
          <div class="col-md-4">
            ...
            <div class="cause shadow-sm">
                ...
                <a href="#" class="cause-link d-block">
                  ...
                  <div class="custom-progress-wrap">
                    <span class="caption">74% complete</span>
                    <div class="custom-progress-inner">
                      <div class="custom-progress bg-warning" style="width: 74%;"></div>
                    </div>
                  </div>
                </a>
                ...
                <div class="px-3 pt-3 border-top-0 border border ">
                  ...
                  <h3 class="mb-4"><a href="#">Kesejahteraan Uyghur</a></h3>
                  <div class="border-top border-light border-bottom py-2 d-flex">
                    <div>Donated</div>
                    <div class="ml-auto"><strong class="text-primary">$74,919</strong></div>
                  </div>
    ...
    <div class="bg-image overlay site-section" style="background-image: url{!! asset('assets/images/hero_1.jpg'); !!}">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="event-29191 mb-5">
              <a href="#" class="d-block mb-3"><img src="{!! asset('assets/images/img_1.jpg') !!}" alt="Image" class="img-fluid rounded"></a>
              <div class="px-3 d-flex">
                ...
                <div>
                  ...
                  <h3><a href="single">Seminar Kesehatan Dasar</a></h3>
                </div>
          ...
          <div class="col-md-6">
            <div class="event-29191 mb-5">
              <a href="#" class="d-block mb-3"><img src="{!! asset('assets/images/img_2.jpg') !!}" alt="Image" class="img-fluid rounded"></a>
              <div class="px-3 d-flex">
                ...
                <div>
                  <div class="mb-3">
                    <span class="mr-3"> <span class="icon-clock-o mr-2 text-muted"></span>9:30 AM &mdash; 11:30 AM</span>
                    <span> <span class="icon-room mr-2 text-muted"></span>Gaza Palestina</span>
                  </div>
                  <h3><a href="single">Kelas baru</a></h3>
                </div>
    ...
    <div class="site-section bg-image overlay-primary" style="background-image: url{!! asset('assets/images/img_1.jpg'); !!}">
      <div class="container">
        <div class="row align-items-stretch">
          <div class="col-md-6">
            <img src="{!! asset('assets/images/img_1.jpg') !!}" alt="Image" class="img-fluid shadow">
          </div>
          <div class="col-md-6">
