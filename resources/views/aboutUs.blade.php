...
<div class="owl-carousel-wrapper">
      ...
      <div class="box-92819">
        ...
        <p class="lead text-white">Donate adalah website perantara untuk anda yang ingin membantu saudara-saudara kita yang membutuhkan dengan donasi online!</p>
      </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            ...
            <p>Menjadi pengelola donasi terbaik dan terpercaya di dunia.</p>
            <p><a href="contact" class="btn btn-primary rounded-0 px-4">Contact Us</a></p>
          </div>
        </div>
      </div>
    </div>
